    ...
    const toggleVideo = (action: string) => {
      ...
      switch (action) {
        case 'toggle': {
          ...
          const l2 = 'https://vod.jiankao.wang/2202c169cc614d6c87bc18577ce0cf3f/bef9cd89fcb348728dbd5a68477a110a-27ccfc3e8264433c1bd3c6ec23e0565a-sd.m3u8'
          // 获取当前的播放地址
          let src = player.invoke('src')
          src = src === l2 ? l1 : l2
          player.invoke('src', src)
          break
        }
        case 'play': {
          player.invoke('play')
